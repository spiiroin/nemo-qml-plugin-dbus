...
ApplicationWindow {
  ...
  property var signalTodo : [
    ...
    ping, {type:'s', value:'FAKE1'},            "ping: complex1",
    ping, {type:'s', value:'FAKE2'},            "ping: complex2",
    ping, {type:'s', value:'FAKE3'},            "ping: complex3",
    ping, {type:'s', value:'FAKE4'},            "ping: complex4",
  ]
  ...
  property var methodTodo : [
    ...
    repr, {type:'s',value:'FAKE1'},           "repr: complex message1",      'variant int32:42',
    echo, {type:'s',value:'FAKE1'},           "echo: complex message1",      42,
    repr, {type:'s',value:'FAKE2'},           "repr: complex message2",      'array [ key string:"foo" val int32:1 key string:"bar" val int32:2 key string:"baf" val int32:3 ]',
    echo, {type:'s',value:'FAKE2'},           "echo: complex message2",      {foo:1,bar:2,baf:3},
    repr, {type:'s',value:'FAKE3'},           "repr: complex message3",      'array [ variant int32:4 variant int32:5 variant int32:6 ]',
    echo, {type:'s',value:'FAKE3'},           "echo: complex message3",      [4,5,6],
    repr, {type:'s',value:'FAKE4'},           "repr: complex message4",      'struct { byte:255 boolean:true int16:32767 int32:2147483647 int64:9223372036854775807 uint16:65535 uint32:4294967295 uint64:18446744073709551615 double:3.75 string:"string" objpath:"/obj/path" signature:"sointu" }',
    echo, {type:'s',value:'FAKE4'},           "echo: complex message4",      [255,true,32767,2147483647,9223372036854775807,65535,4294967295,18446744073709551615,3.75,"string","/obj/path","sointu"],
  ]
